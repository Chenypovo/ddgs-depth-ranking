...
def main():
 ...
 hashes['evaluator']=hashlib.sha256((root/'scripts/evaluate/evaluate_corrections.py').read_bytes()).hexdigest()
 ...
 try:
  for item in plan:
   ...
   if args.stage=='compare':
    ...
    run([py,root/'scripts/evaluate/evaluate_corrections.py','--model',model],model/'evaluation.log',env)
