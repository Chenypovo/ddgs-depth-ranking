...
entries = [root / p for p in [
    ...
    'methods/rank_supervision.py', 'scripts/setup/prepare_rank_source.py', 'scripts/checks/check_rank_supervision.py',
    'scripts/evaluate/evaluate_rank.py', 'scripts/train/run_rank_comparison.py', 'methods/opacity_expectation.py',
