...
r=Path(__file__).resolve().parent;sys.path.insert(0,str(r/'depth-anything-v2'))
from depth_anything_v2.dpt import DepthAnythingV2
scene=r/'dataset/nerf_llff_data/fern';split=json.loads((scene/'3_views/split.json').read_text());assert split['state']=='complete'
out=r/'fern_priors';out.mkdir(exist_ok=False)
masks=r/'DDGS_fern/preprocessed_masks_5/fern/r8';masks.mkdir(parents=True,exist_ok=False)
