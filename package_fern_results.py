...
r=Path(__file__).resolve().parent;assert json.loads((r/'fern_runs/compare/results.json').read_text())['state']=='complete'
...
names=['fern_data_identity.json','downloads/source.txt','package_fern_results.py','fern_runs','DDGS_fern','fern_priors','fern_integration.json','fern_integration','fern_source_identity.json','prepare_fern_source.py','prepare_fern_priors.py','check_fern_supervision.py','evaluate_fern.py','run_fern_comparison.py','opacity_expectation.py','prepare_scene.py','FERN_VALIDATION_PROTOCOL.md','fern_prepare.log','fern_runner.log','dataset/nerf_llff_data/fern/3_views/split.json','dataset/nerf_llff_data/fern/3_views/dense/fused.ply','dataset/nerf_llff_data/fern/3_views/created','dataset/nerf_llff_data/fern/3_views/triangulated','room_prepare.log','room_fusion_repair.log','repair_room_fusion.py','ROOM_VALIDATION_PROTOCOL.md','dataset/nerf_llff_data/room/3_views/split.json','dataset/nerf_llff_data/room/3_views/dense/fused_default5_failed.ply','dataset/nerf_llff_data/room/3_views/dense/fused_min3.ply']
files=[]
for n in names:
